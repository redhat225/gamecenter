...
.has-text-gamecenter-pink {
  color: #ec008c !important; }

a.has-text-gamecenter-pink:hover, a.has-text-gamecenter-pink:focus {
  color: #b9006e !important; }

.has-text-gamecenter-blue {
  color: #110e39 !important; }

a.has-text-gamecenter-blue:hover, a.has-text-gamecenter-blue:focus {
  ...
  .button.is-danger {
    ...
    .button.is-danger.is-inverted.is-outlined {
      ...
      .button.is-danger.is-inverted.is-outlined[disabled] {
        ...
        box-shadow: none;
        color: #fff; }
  .button.is-gamecenter-pink {
    background-color: #ec008c;
    border-color: transparent;
    color: #fff; }
    .button.is-gamecenter-pink:hover, .button.is-gamecenter-pink.is-hovered {
      background-color: #df0084;
      border-color: transparent;
      color: #fff; }
    .button.is-gamecenter-pink:focus, .button.is-gamecenter-pink.is-focused {
      border-color: transparent;
      color: #fff; }
      .button.is-gamecenter-pink:focus:not(:active), .button.is-gamecenter-pink.is-focused:not(:active) {
        box-shadow: 0 0 0 0.125em rgba(236, 0, 140, 0.25); }
    .button.is-gamecenter-pink:active, .button.is-gamecenter-pink.is-active {
      background-color: #d3007d;
      border-color: transparent;
      color: #fff; }
    .button.is-gamecenter-pink[disabled] {
      background-color: #ec008c;
      border-color: transparent;
      box-shadow: none; }
    .button.is-gamecenter-pink.is-inverted {
      background-color: #fff;
      color: #ec008c; }
      .button.is-gamecenter-pink.is-inverted:hover {
        background-color: #f2f2f2; }
      .button.is-gamecenter-pink.is-inverted[disabled] {
        background-color: #fff;
        border-color: transparent;
        box-shadow: none;
        color: #ec008c; }
    .button.is-gamecenter-pink.is-loading:after {
      border-color: transparent transparent #fff #fff !important; }
    .button.is-gamecenter-pink.is-outlined {
      background-color: transparent;
      border-color: #ec008c;
      color: #ec008c; }
      .button.is-gamecenter-pink.is-outlined:hover, .button.is-gamecenter-pink.is-outlined:focus {
        background-color: #ec008c;
        border-color: #ec008c;
        color: #fff; }
      .button.is-gamecenter-pink.is-outlined.is-loading:after {
        border-color: transparent transparent #ec008c #ec008c !important; }
      .button.is-gamecenter-pink.is-outlined[disabled] {
        background-color: transparent;
        border-color: #ec008c;
        box-shadow: none;
        color: #ec008c; }
    .button.is-gamecenter-pink.is-inverted.is-outlined {
      background-color: transparent;
      border-color: #fff;
      color: #fff; }
      .button.is-gamecenter-pink.is-inverted.is-outlined:hover, .button.is-gamecenter-pink.is-inverted.is-outlined:focus {
        background-color: #fff;
        color: #ec008c; }
      .button.is-gamecenter-pink.is-inverted.is-outlined[disabled] {
        background-color: transparent;
        border-color: #fff;
        box-shadow: none;
        color: #fff; }
  .button.is-gamecenter-blue {
    background-color: #110e39;
    border-color: transparent;
    color: #fff; }
    .button.is-gamecenter-blue:hover, .button.is-gamecenter-blue.is-hovered {
      background-color: #0e0b2f;
      border-color: transparent;
      color: #fff; }
    .button.is-gamecenter-blue:focus, .button.is-gamecenter-blue.is-focused {
      border-color: transparent;
      color: #fff; }
      .button.is-gamecenter-blue:focus:not(:active), .button.is-gamecenter-blue.is-focused:not(:active) {
        box-shadow: 0 0 0 0.125em rgba(17, 14, 57, 0.25); }
    .button.is-gamecenter-blue:active, .button.is-gamecenter-blue.is-active {
      background-color: #0b0925;
      border-color: transparent;
      color: #fff; }
    .button.is-gamecenter-blue[disabled] {
      background-color: #110e39;
      border-color: transparent;
      box-shadow: none; }
    .button.is-gamecenter-blue.is-inverted {
      background-color: #fff;
      color: #110e39; }
      .button.is-gamecenter-blue.is-inverted:hover {
        background-color: #f2f2f2; }
      .button.is-gamecenter-blue.is-inverted[disabled] {
        background-color: #fff;
        border-color: transparent;
        box-shadow: none;
        color: #110e39; }
    .button.is-gamecenter-blue.is-loading:after {
      border-color: transparent transparent #fff #fff !important; }
    .button.is-gamecenter-blue.is-outlined {
      background-color: transparent;
      border-color: #110e39;
      color: #110e39; }
      .button.is-gamecenter-blue.is-outlined:hover, .button.is-gamecenter-blue.is-outlined:focus {
        background-color: #110e39;
        border-color: #110e39;
        color: #fff; }
      .button.is-gamecenter-blue.is-outlined.is-loading:after {
        border-color: transparent transparent #110e39 #110e39 !important; }
      .button.is-gamecenter-blue.is-outlined[disabled] {
        background-color: transparent;
        border-color: #110e39;
        box-shadow: none;
        color: #110e39; }
    .button.is-gamecenter-blue.is-inverted.is-outlined {
      background-color: transparent;
      border-color: #fff;
      color: #fff; }
      .button.is-gamecenter-blue.is-inverted.is-outlined:hover, .button.is-gamecenter-blue.is-inverted.is-outlined:focus {
        background-color: #fff;
        color: #110e39; }
      .button.is-gamecenter-blue.is-inverted.is-outlined[disabled] {
        background-color: transparent;
        border-color: #fff;
        box-shadow: none;
        color: #fff; }
...
.textarea {
  ...
  .textarea.is-danger {
    ...
    .textarea.is-danger.is-active {
      box-shadow: 0 0 0 0.125em rgba(255, 56, 96, 0.25); }
  .input.is-gamecenter-pink,
  .textarea.is-gamecenter-pink {
    border-color: #ec008c; }
    .input.is-gamecenter-pink:focus, .input.is-gamecenter-pink.is-focused, .input.is-gamecenter-pink:active, .input.is-gamecenter-pink.is-active,
    .textarea.is-gamecenter-pink:focus,
    .textarea.is-gamecenter-pink.is-focused,
    .textarea.is-gamecenter-pink:active,
    .textarea.is-gamecenter-pink.is-active {
      box-shadow: 0 0 0 0.125em rgba(236, 0, 140, 0.25); }
  .input.is-gamecenter-blue,
  .textarea.is-gamecenter-blue {
    border-color: #110e39; }
    .input.is-gamecenter-blue:focus, .input.is-gamecenter-blue.is-focused, .input.is-gamecenter-blue:active, .input.is-gamecenter-blue.is-active,
    .textarea.is-gamecenter-blue:focus,
    .textarea.is-gamecenter-blue.is-focused,
    .textarea.is-gamecenter-blue:active,
    .textarea.is-gamecenter-blue.is-active {
      box-shadow: 0 0 0 0.125em rgba(17, 14, 57, 0.25); }
  .input.is-small,
  .textarea.is-small {
    border-radius: 2px;
...
.select {
  ...
  .select.is-danger select {
    ...
    .select.is-danger select:focus, .select.is-danger select.is-focused, .select.is-danger select:active, .select.is-danger select.is-active {
      box-shadow: 0 0 0 0.125em rgba(255, 56, 96, 0.25); }
  .select.is-gamecenter-pink select {
    border-color: #ec008c; }
    .select.is-gamecenter-pink select:focus, .select.is-gamecenter-pink select.is-focused, .select.is-gamecenter-pink select:active, .select.is-gamecenter-pink select.is-active {
      box-shadow: 0 0 0 0.125em rgba(236, 0, 140, 0.25); }
  .select.is-gamecenter-blue select {
    border-color: #110e39; }
    .select.is-gamecenter-blue select:focus, .select.is-gamecenter-blue select.is-focused, .select.is-gamecenter-blue select:active, .select.is-gamecenter-blue select.is-active {
      box-shadow: 0 0 0 0.125em rgba(17, 14, 57, 0.25); }
  .select.is-small {
    border-radius: 2px;
    font-size: 0.75rem; }
...
.file {
  ...
  .file.is-danger:active .file-cta, .file.is-danger.is-active .file-cta {
    ...
    border-color: transparent;
    color: #fff; }
  .file.is-gamecenter-pink .file-cta {
    background-color: #ec008c;
    border-color: transparent;
    color: #fff; }
  .file.is-gamecenter-pink:hover .file-cta, .file.is-gamecenter-pink.is-hovered .file-cta {
    background-color: #df0084;
    border-color: transparent;
    color: #fff; }
  .file.is-gamecenter-pink:focus .file-cta, .file.is-gamecenter-pink.is-focused .file-cta {
    border-color: transparent;
    box-shadow: 0 0 0.5em rgba(236, 0, 140, 0.25);
    color: #fff; }
  .file.is-gamecenter-pink:active .file-cta, .file.is-gamecenter-pink.is-active .file-cta {
    background-color: #d3007d;
    border-color: transparent;
    color: #fff; }
  .file.is-gamecenter-blue .file-cta {
    background-color: #110e39;
    border-color: transparent;
    color: #fff; }
  .file.is-gamecenter-blue:hover .file-cta, .file.is-gamecenter-blue.is-hovered .file-cta {
    background-color: #0e0b2f;
    border-color: transparent;
    color: #fff; }
  .file.is-gamecenter-blue:focus .file-cta, .file.is-gamecenter-blue.is-focused .file-cta {
    border-color: transparent;
    box-shadow: 0 0 0.5em rgba(17, 14, 57, 0.25);
    color: #fff; }
  .file.is-gamecenter-blue:active .file-cta, .file.is-gamecenter-blue.is-active .file-cta {
    background-color: #0b0925;
    border-color: transparent;
    color: #fff; }
  .file.is-small {
...
.help {
  ...
  .help.is-danger {
    color: #ff3860; }
  .help.is-gamecenter-pink {
    color: #ec008c; }
  .help.is-gamecenter-blue {
    color: #110e39; }
...
.notification {
  ...
  .notification.is-danger {
    background-color: #ff3860;
    color: #fff; }
  .notification.is-gamecenter-pink {
    background-color: #ec008c;
    color: #fff; }
  .notification.is-gamecenter-blue {
    background-color: #110e39;
    color: #fff; }
...
.progress {
  ...
  .progress.is-danger::-ms-fill {
    background-color: #ff3860; }
  .progress.is-gamecenter-pink::-webkit-progress-value {
    background-color: #ec008c; }
  .progress.is-gamecenter-pink::-moz-progress-bar {
    background-color: #ec008c; }
  .progress.is-gamecenter-pink::-ms-fill {
    background-color: #ec008c; }
  .progress.is-gamecenter-blue::-webkit-progress-value {
    background-color: #110e39; }
  .progress.is-gamecenter-blue::-moz-progress-bar {
    background-color: #110e39; }
  .progress.is-gamecenter-blue::-ms-fill {
    background-color: #110e39; }
  .progress.is-small {
    height: 0.75rem; }
  .progress.is-medium {
...
.table {
  ...
  .table th {
    ...
    .table th.is-danger {
      ...
      border-color: #ff3860;
      color: #fff; }
    .table td.is-gamecenter-pink,
    .table th.is-gamecenter-pink {
      background-color: #ec008c;
      border-color: #ec008c;
      color: #fff; }
    .table td.is-gamecenter-blue,
    .table th.is-gamecenter-blue {
      background-color: #110e39;
      border-color: #110e39;
      color: #fff; }
    .table td.is-narrow,
...
.tag:not(body) {
  ...
  .tag:not(body).is-danger {
    background-color: #ff3860;
    color: #fff; }
  .tag:not(body).is-gamecenter-pink {
    background-color: #ec008c;
    color: #fff; }
  .tag:not(body).is-gamecenter-blue {
    background-color: #110e39;
    color: #fff; }
...
.message {
  ...
  .message.is-danger {
    ...
    .message.is-danger .message-body {
      border-color: #ff3860;
      color: #cd0930; }
  .message.is-gamecenter-pink {
    background-color: #fff5fb; }
    .message.is-gamecenter-pink .message-header {
      background-color: #ec008c;
      color: #fff; }
    .message.is-gamecenter-pink .message-body {
      border-color: #ec008c;
      color: #9d055f; }
  .message.is-gamecenter-blue {
    background-color: #f7f7fd; }
    .message.is-gamecenter-blue .message-header {
      background-color: #110e39;
      color: #fff; }
    .message.is-gamecenter-blue .message-body {
      border-color: #110e39;
      color: #100d34; }
  ...
  .navbar.is-danger {
    ...
    @media screen and (min-width: 1024px) {
      ...
      .navbar.is-danger .navbar-dropdown a.navbar-item.is-active {
        background-color: #ff3860;
        color: #fff; } }
  .navbar.is-gamecenter-pink {
    background-color: #ec008c;
    color: #fff; }
    .navbar.is-gamecenter-pink .navbar-brand > .navbar-item,
    .navbar.is-gamecenter-pink .navbar-brand .navbar-link {
      color: #fff; }
    .navbar.is-gamecenter-pink .navbar-brand > a.navbar-item:hover, .navbar.is-gamecenter-pink .navbar-brand > a.navbar-item.is-active,
    .navbar.is-gamecenter-pink .navbar-brand .navbar-link:hover,
    .navbar.is-gamecenter-pink .navbar-brand .navbar-link.is-active {
      background-color: #d3007d;
      color: #fff; }
    .navbar.is-gamecenter-pink .navbar-brand .navbar-link::after {
      border-color: #fff; }
    @media screen and (min-width: 1024px) {
      .navbar.is-gamecenter-pink .navbar-start > .navbar-item,
      .navbar.is-gamecenter-pink .navbar-start .navbar-link,
      .navbar.is-gamecenter-pink .navbar-end > .navbar-item,
      .navbar.is-gamecenter-pink .navbar-end .navbar-link {
        color: #fff; }
      .navbar.is-gamecenter-pink .navbar-start > a.navbar-item:hover, .navbar.is-gamecenter-pink .navbar-start > a.navbar-item.is-active,
      .navbar.is-gamecenter-pink .navbar-start .navbar-link:hover,
      .navbar.is-gamecenter-pink .navbar-start .navbar-link.is-active,
      .navbar.is-gamecenter-pink .navbar-end > a.navbar-item:hover,
      .navbar.is-gamecenter-pink .navbar-end > a.navbar-item.is-active,
      .navbar.is-gamecenter-pink .navbar-end .navbar-link:hover,
      .navbar.is-gamecenter-pink .navbar-end .navbar-link.is-active {
        background-color: #d3007d;
        color: #fff; }
      .navbar.is-gamecenter-pink .navbar-start .navbar-link::after,
      .navbar.is-gamecenter-pink .navbar-end .navbar-link::after {
        border-color: #fff; }
      .navbar.is-gamecenter-pink .navbar-item.has-dropdown:hover .navbar-link,
      .navbar.is-gamecenter-pink .navbar-item.has-dropdown.is-active .navbar-link {
        background-color: #d3007d;
        color: #fff; }
      .navbar.is-gamecenter-pink .navbar-dropdown a.navbar-item.is-active {
        background-color: #ec008c;
        color: #fff; } }
  .navbar.is-gamecenter-blue {
    background-color: #110e39;
    color: #fff; }
    .navbar.is-gamecenter-blue .navbar-brand > .navbar-item,
    .navbar.is-gamecenter-blue .navbar-brand .navbar-link {
      color: #fff; }
    .navbar.is-gamecenter-blue .navbar-brand > a.navbar-item:hover, .navbar.is-gamecenter-blue .navbar-brand > a.navbar-item.is-active,
    .navbar.is-gamecenter-blue .navbar-brand .navbar-link:hover,
    .navbar.is-gamecenter-blue .navbar-brand .navbar-link.is-active {
      background-color: #0b0925;
      color: #fff; }
    .navbar.is-gamecenter-blue .navbar-brand .navbar-link::after {
      border-color: #fff; }
    @media screen and (min-width: 1024px) {
      .navbar.is-gamecenter-blue .navbar-start > .navbar-item,
      .navbar.is-gamecenter-blue .navbar-start .navbar-link,
      .navbar.is-gamecenter-blue .navbar-end > .navbar-item,
      .navbar.is-gamecenter-blue .navbar-end .navbar-link {
        color: #fff; }
      .navbar.is-gamecenter-blue .navbar-start > a.navbar-item:hover, .navbar.is-gamecenter-blue .navbar-start > a.navbar-item.is-active,
      .navbar.is-gamecenter-blue .navbar-start .navbar-link:hover,
      .navbar.is-gamecenter-blue .navbar-start .navbar-link.is-active,
      .navbar.is-gamecenter-blue .navbar-end > a.navbar-item:hover,
      .navbar.is-gamecenter-blue .navbar-end > a.navbar-item.is-active,
      .navbar.is-gamecenter-blue .navbar-end .navbar-link:hover,
      .navbar.is-gamecenter-blue .navbar-end .navbar-link.is-active {
        background-color: #0b0925;
        color: #fff; }
      .navbar.is-gamecenter-blue .navbar-start .navbar-link::after,
      .navbar.is-gamecenter-blue .navbar-end .navbar-link::after {
        border-color: #fff; }
      .navbar.is-gamecenter-blue .navbar-item.has-dropdown:hover .navbar-link,
      .navbar.is-gamecenter-blue .navbar-item.has-dropdown.is-active .navbar-link {
        background-color: #0b0925;
        color: #fff; }
      .navbar.is-gamecenter-blue .navbar-dropdown a.navbar-item.is-active {
        background-color: #110e39;
        color: #fff; } }
  .navbar > .container {
    align-items: stretch;
    ...
    .hero.is-danger.is-bold {
      ...
      @media screen and (max-width: 768px) {
        .hero.is-danger.is-bold .navbar-menu {
          background-image: linear-gradient(141deg, #ff0561 0%, #ff3860 71%, #ff5257 100%); } }
  .hero.is-gamecenter-pink {
    background-color: #ec008c;
    color: #fff; }
    .hero.is-gamecenter-pink a:not(.button):not(.dropdown-item):not(.tag),
    .hero.is-gamecenter-pink strong {
      color: inherit; }
    .hero.is-gamecenter-pink .title {
      color: #fff; }
    .hero.is-gamecenter-pink .subtitle {
      color: rgba(255, 255, 255, 0.9); }
      .hero.is-gamecenter-pink .subtitle a:not(.button),
      .hero.is-gamecenter-pink .subtitle strong {
        color: #fff; }
    @media screen and (max-width: 1023px) {
      .hero.is-gamecenter-pink .navbar-menu {
        background-color: #ec008c; } }
    .hero.is-gamecenter-pink .navbar-item,
    .hero.is-gamecenter-pink .navbar-link {
      color: rgba(255, 255, 255, 0.7); }
    .hero.is-gamecenter-pink a.navbar-item:hover, .hero.is-gamecenter-pink a.navbar-item.is-active,
    .hero.is-gamecenter-pink .navbar-link:hover,
    .hero.is-gamecenter-pink .navbar-link.is-active {
      background-color: #d3007d;
      color: #fff; }
    .hero.is-gamecenter-pink .tabs a {
      color: #fff;
      opacity: 0.9; }
      .hero.is-gamecenter-pink .tabs a:hover {
        opacity: 1; }
    .hero.is-gamecenter-pink .tabs li.is-active a {
      opacity: 1; }
    .hero.is-gamecenter-pink .tabs.is-boxed a, .hero.is-gamecenter-pink .tabs.is-toggle a {
      color: #fff; }
      .hero.is-gamecenter-pink .tabs.is-boxed a:hover, .hero.is-gamecenter-pink .tabs.is-toggle a:hover {
        background-color: rgba(10, 10, 10, 0.1); }
    .hero.is-gamecenter-pink .tabs.is-boxed li.is-active a, .hero.is-gamecenter-pink .tabs.is-boxed li.is-active a:hover, .hero.is-gamecenter-pink .tabs.is-toggle li.is-active a, .hero.is-gamecenter-pink .tabs.is-toggle li.is-active a:hover {
      background-color: #fff;
      border-color: #fff;
      color: #ec008c; }
    .hero.is-gamecenter-pink.is-bold {
      background-image: linear-gradient(141deg, #b9008d 0%, #ec008c 71%, #ff0770 100%); }
      @media screen and (max-width: 768px) {
        .hero.is-gamecenter-pink.is-bold .navbar-menu {
          background-image: linear-gradient(141deg, #b9008d 0%, #ec008c 71%, #ff0770 100%); } }
  .hero.is-gamecenter-blue {
    background-color: #110e39;
    color: #fff; }
    .hero.is-gamecenter-blue a:not(.button):not(.dropdown-item):not(.tag),
    .hero.is-gamecenter-blue strong {
      color: inherit; }
    .hero.is-gamecenter-blue .title {
      color: #fff; }
    .hero.is-gamecenter-blue .subtitle {
      color: rgba(255, 255, 255, 0.9); }
      .hero.is-gamecenter-blue .subtitle a:not(.button),
      .hero.is-gamecenter-blue .subtitle strong {
        color: #fff; }
    @media screen and (max-width: 1023px) {
      .hero.is-gamecenter-blue .navbar-menu {
        background-color: #110e39; } }
    .hero.is-gamecenter-blue .navbar-item,
    .hero.is-gamecenter-blue .navbar-link {
      color: rgba(255, 255, 255, 0.7); }
    .hero.is-gamecenter-blue a.navbar-item:hover, .hero.is-gamecenter-blue a.navbar-item.is-active,
    .hero.is-gamecenter-blue .navbar-link:hover,
    .hero.is-gamecenter-blue .navbar-link.is-active {
      background-color: #0b0925;
      color: #fff; }
    .hero.is-gamecenter-blue .tabs a {
      color: #fff;
      opacity: 0.9; }
      .hero.is-gamecenter-blue .tabs a:hover {
        opacity: 1; }
    .hero.is-gamecenter-blue .tabs li.is-active a {
      opacity: 1; }
    .hero.is-gamecenter-blue .tabs.is-boxed a, .hero.is-gamecenter-blue .tabs.is-toggle a {
      color: #fff; }
      .hero.is-gamecenter-blue .tabs.is-boxed a:hover, .hero.is-gamecenter-blue .tabs.is-toggle a:hover {
        background-color: rgba(10, 10, 10, 0.1); }
    .hero.is-gamecenter-blue .tabs.is-boxed li.is-active a, .hero.is-gamecenter-blue .tabs.is-boxed li.is-active a:hover, .hero.is-gamecenter-blue .tabs.is-toggle li.is-active a, .hero.is-gamecenter-blue .tabs.is-toggle li.is-active a:hover {
      background-color: #fff;
      border-color: #fff;
      color: #110e39; }
    .hero.is-gamecenter-blue.is-bold {
      background-image: linear-gradient(141deg, #030411 0%, #110e39 71%, #201150 100%); }
      @media screen and (max-width: 768px) {
        .hero.is-gamecenter-blue.is-bold .navbar-menu {
          background-image: linear-gradient(141deg, #030411 0%, #110e39 71%, #201150 100%); } }
...
.tooltip {
  ...
  .tooltip.is-tooltip-danger::before {
    ...
    color: #fff; }
  .tooltip.is-tooltip-gamecenter-pink:not(.is-loading)::after {
    border-color: rgba(236, 0, 140, 0.9) transparent transparent transparent; }
  .tooltip.is-tooltip-gamecenter-pink.is-tooltip-right:not(.is-loading)::after {
    border-color: transparent rgba(236, 0, 140, 0.9) transparent transparent; }
  .tooltip.is-tooltip-gamecenter-pink.is-tooltip-bottom:not(.is-loading)::after {
    border-color: transparent transparent rgba(236, 0, 140, 0.9) transparent; }
  .tooltip.is-tooltip-gamecenter-pink.is-tooltip-left:not(.is-loading)::after {
    border-color: transparent transparent transparent rgba(236, 0, 140, 0.9); }
  .tooltip.is-tooltip-gamecenter-pink::before {
    background: rgba(236, 0, 140, 0.9);
    color: #fff; }
  .tooltip.is-tooltip-gamecenter-blue:not(.is-loading)::after {
    border-color: rgba(17, 14, 57, 0.9) transparent transparent transparent; }
  .tooltip.is-tooltip-gamecenter-blue.is-tooltip-right:not(.is-loading)::after {
    border-color: transparent rgba(17, 14, 57, 0.9) transparent transparent; }
  .tooltip.is-tooltip-gamecenter-blue.is-tooltip-bottom:not(.is-loading)::after {
    border-color: transparent transparent rgba(17, 14, 57, 0.9) transparent; }
  .tooltip.is-tooltip-gamecenter-blue.is-tooltip-left:not(.is-loading)::after {
    border-color: transparent transparent transparent rgba(17, 14, 57, 0.9); }
  .tooltip.is-tooltip-gamecenter-blue::before {
    background: rgba(17, 14, 57, 0.9);
    color: #fff; }
...
.pageloader {
  ...
  .pageloader.is-danger {
    ...
    .pageloader.is-danger .title {
      color: #fff; }
  .pageloader.is-gamecenter-pink {
    background-color: #ec008c;
    background: #ec008c; }
    .pageloader.is-gamecenter-pink::after {
      border-color: #fff;
      -webkit-animation: loader-figure-gamecenter-pink 1.15s infinite cubic-bezier(0.215, 0.61, 0.355, 1);
      -moz-animation: loader-figure-gamecenter-pink 1.15s infinite cubic-bezier(0.215, 0.61, 0.355, 1);
      animation: loader-figure-gamecenter-pink 1.15s infinite cubic-bezier(0.215, 0.61, 0.355, 1); }
    .pageloader.is-gamecenter-pink .title {
      color: #fff; }
  .pageloader.is-gamecenter-blue {
    background-color: #110e39;
    background: #110e39; }
    .pageloader.is-gamecenter-blue::after {
      border-color: #fff;
      -webkit-animation: loader-figure-gamecenter-blue 1.15s infinite cubic-bezier(0.215, 0.61, 0.355, 1);
      -moz-animation: loader-figure-gamecenter-blue 1.15s infinite cubic-bezier(0.215, 0.61, 0.355, 1);
      animation: loader-figure-gamecenter-blue 1.15s infinite cubic-bezier(0.215, 0.61, 0.355, 1); }
    .pageloader.is-gamecenter-blue .title {
      color: #fff; }
...
@keyframes loader-figure-danger {
  ...
  100% {
    ...
    opacity: 0;
    background-color: transparent; } }
@-webkit-keyframes loader-figure-gamecenter-pink {
  0% {
    height: 0;
    width: 0;
    background-color: #fff; }
  ...
  100% {
    ...
    opacity: 0;
    background-color: transparent; } }
@-moz-keyframes loader-figure-gamecenter-pink {
  0% {
    height: 0;
    width: 0;
    background-color: #fff; }
  ...
  100% {
    ...
    opacity: 0;
    background-color: transparent; } }
@-o-keyframes loader-figure-gamecenter-pink {
  0% {
    height: 0;
    width: 0;
    background-color: #fff; }
  ...
  100% {
    ...
    opacity: 0;
    background-color: transparent; } }
@keyframes loader-figure-gamecenter-pink {
  0% {
    height: 0;
    width: 0;
    background-color: #fff; }
  ...
  100% {
    ...
    opacity: 0;
    background-color: transparent; } }
@-webkit-keyframes loader-figure-gamecenter-blue {
  0% {
    height: 0;
    width: 0;
    background-color: #fff; }
  ...
  100% {
    ...
    opacity: 0;
    background-color: transparent; } }
@-moz-keyframes loader-figure-gamecenter-blue {
  0% {
    height: 0;
    width: 0;
    background-color: #fff; }
  ...
  100% {
    ...
    opacity: 0;
    background-color: transparent; } }
@-o-keyframes loader-figure-gamecenter-blue {
  0% {
    height: 0;
    width: 0;
    background-color: #fff; }
  ...
  100% {
    ...
    opacity: 0;
    background-color: transparent; } }
@keyframes loader-figure-gamecenter-blue {
  0% {
    height: 0;
    width: 0;
    background-color: #fff; }
